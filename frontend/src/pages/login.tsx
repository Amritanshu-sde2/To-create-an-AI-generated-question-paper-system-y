...
export default function Login() {
  ...
  const title = 'To create an AI-generated question paper system y'
  ...
  const setLogin = (target) => {
    ...
    setInitialValues(prev => {
      return {...prev, email, password: '05c22847'}
    })
  }
                  ...
                  <div className='flex flex-row text-gray-500 justify-between'>
                        <div>
                            <p className='mb-2'>Use{' '}
                                ...
                                <code className={`${textColor}`}>05c22847</code>{' / '}
                                to login as Admin</p>
                            <p>Use <code
                                className={`cursor-pointer ${textColor} `}
                                onClick={(e) => setLogin(e.target)}>client@hello.com</code>{' / '}
                                <code className={`${textColor}`}>ac04595a37ed</code>{' / '}
                                to login as User</p>
                        </div>
                        <div>
                            <BaseIcon
