...
router.post('/', wrapAsync(async (req, res) => {
    ...
    await QuestionsService.create(req.body.data, req.currentUser, true, link.host);
    const payload = true;
...
router.get('/', wrapAsync(async (req, res) => {
  ...
  const payload = await QuestionsDBApi.findAll(
...
router.get('/:id', wrapAsync(async (req, res) => {
  const payload = await QuestionsDBApi.findBy(
    { id: req.params.id },
  );
